...
const Header = () => {
  ...
  return (
    <Box bg='#000000e5' w='100%' h='90px' color='lawngreen' boxShadow='xl' pos='fixed' p ='1rem 4rem'>
        <Flex >
            <Flex fontSize='3xl' pl={6} textTransform={'uppercase'} className='logo' justify={'space-between'} align={'center'} color='lawngreen'><FaCode/>Cynthia<FaCode/></Flex>
            <Spacer/>
            <Flex pr={9} w='40%' justify={'space-between'} align={'center'} fontWeight='bold'>
              ...
              <Text color='white' fontSize='xl'><ChakraLink as={ReactRouterLink} to='/contact'>{isSmallScreen ? <MdWifiCalling3 style={{fontSize: "40px"}}/> : 'Contact Me'}</ChakraLink></Text>
            </Flex>
        </Flex>
    </Box>
  )
