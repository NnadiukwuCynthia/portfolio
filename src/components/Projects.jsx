...
const Projects = () => {
    return (
        <Box textAlign='center'>
            <Text align='center' textTransform='uppercase' fontSize='50px' fontWeight='bold' color='white'>My Projects</Text>
            <Text color='crimson' textTransform='uppercase' mb='1rem' >Here are some of my personal projects</Text>
            
            <Flex justify='center' align='center' w='100%' wrap='wrap'>
            <Box w='22%' h='auto' m='30px' pb='40px' borderRadius='xl' bg='#1e1e1e'>
