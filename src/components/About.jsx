...
const About = () => {
  return (
    <Box  m='0 auto' bg='#000000' w='70%'>
        <Text align='center' mb='1rem' textTransform='uppercase' fontSize='50px' fontWeight='bold' color='white' fontFamily='Protest Riot'>About Me</Text>
        <Text color='white' fontSize= '17px' pt='15px' fontFamily='Roboto'>
