...
const About = () => {
  return (
    <Box  m='auto'  w='70%' className="about">
        <Text align='center' mb='2rem' textTransform='uppercase' fontSize='50px' fontWeight='bold' color='white'>About Me</Text>
        <Text color='white' fontSize='20px' pt='1rem' className="about__aboutDetails">
        ...
        <Text color='white' fontSize='20px' pt='1rem' className="about__aboutDetails">
            Driven by an insatiable curiosity for emerging technologies and industry trends, I continuously seek out new knowledge and skills to stay at the forefront of the rapidly evolving digital landscape. Whether it is experimenting with the latest frameworks, exploring innovative design patterns, or diving deep into accessibility best practices, I approach every challenge as an opportunity to expand my expertise and deliver innovative solutions.
        </Text>
        <Text color='white' fontSize='20px' pt='1rem' className="about__aboutDetails">
