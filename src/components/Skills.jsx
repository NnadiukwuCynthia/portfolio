...
const Skills = () => {
  return (
    <Flex justify={'center'} align={'center'} direction={'column'} width='100%' pb='20px'>
        ...
        <Flex justify={'space-between'} align={'center'}  width='80%'>
            ...
            <Stack width='33%' height='400px' bg='#1e293b' borderRadius='xl' py='10px'>
              ...
              <Text color='#ffffff' border='2px' borderColor='lawngreen' padding='10px' width='150px' align='center' borderRadius='xl' m='6px'>Communication</Text>
              <Text color='#ffffff' border='2px' borderColor='white' padding='10px' width='110px' align='center' borderRadius='xl' m='6px'>Team work</Text>
              <Text color='#ffffff' border='2px' borderColor='orange' padding='10px' width='160px' align='center' borderRadius='xl' m='6px'>Problem-solving</Text>
              <Text color='#ffffff' border='2px' borderColor='red' padding='10px' width='110px' align='center' borderRadius='xl' m='6px'>Adaptability</Text>
              <Text color='#ffffff' border='2px' borderColor='yellow' padding='10px' width='160px' align='center' borderRadius='xl' m='6px'>Critical Thinking</Text>
              <Text color='#ffffff' border='2px' borderColor='lawngreen' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>Creativity</Text>
              <Text color='#ffffff' border='2px' borderColor='blue' padding='10px' width='170px' align='center' borderRadius='xl' m='6px'>Time Management</Text>
              <Text color='#ffffff' border='2px' borderColor='pink' padding='10px' width='110px' align='center' borderRadius='xl' m='6px'>Empathy</Text>
              <Text color='#ffffff' border='2px' borderColor='white' padding='10px' width='110px' align='center' borderRadius='xl' m='6px'>Leadership</Text>
              <Text color='#ffffff' border='2px' borderColor='violet' padding='10px' width='190px' align='center' borderRadius='xl' m='6px'>Emotional Intelligence</Text>
              </Flex>
            </Stack>
        </Flex>
    </Flex>
