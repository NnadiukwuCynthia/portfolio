    ...
    <Flex justify={'center'} align={'center'} direction={'column'} width='100%' pb='40px' mt='50px' bg='#1e1e1e'>
        ...
        <Flex justify={'space-between'} align={'center'}  width='80%'>
            ...
            <Stack width='31%' height='400px' bg='#1e293b' borderRadius='xl' py='10px'>
              ...
              <Flex wrap='wrap' ml='25px'>
              <Text color='#ffffff' border='4px' borderColor='lawngreen' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>HTML5</Text>
              <Text  color='#ffffff' border='4px' borderColor='white' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>CSS3</Text>
              <Text color='#ffffff' border='4px' borderColor='orange' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>SASS</Text>
              <Text color='#ffffff' border='4px' borderColor='yellow' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>JavaScript</Text>
              <Text color='#ffffff' border='4px' borderColor='red' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>React</Text>
              <Text color='#ffffff' border='4px' borderColor='blue' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>Next</Text>
              <Text color='#ffffff' border='4px' borderColor='white' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>Tailwind CSS</Text>
              <Text color='#ffffff' border='4px' borderColor='lawngreen' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>Chakra Ui</Text>
              <Text color='#ffffff' border='4px' borderColor='violet' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>Git</Text>
              <Text color='#ffffff' border='4px' borderColor='pink' padding='10px' width='140px' align='center' borderRadius='xl' m='6px'>Chakra Ui</Text>
              </Flex>
              </Stack>
